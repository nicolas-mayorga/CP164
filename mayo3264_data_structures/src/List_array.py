...
class List:
    ...
    def _is_valid_index(self, i):
        ...
        return True if -(len(self._values)) <= i <= (len(self._values) - 1) else False
    ...
    def _linear_search(self, key):
        ...
        if key in self._values:
            while len(self._values) > 0 and self._values[i] != key and i <= len(self._values):
                i += 1
        else:
            i = -1
    ...
    def combine(self, source1, source2):
        ...
        if len(source1._values) > len(source2._values):
            short = source2._values
            long = source1._values

        else:
            long = source2._values
            short = source1._values

        while len(short) > 0:
            self._values.append(source1._values[0])
            source1._values.pop(0)
            self._values.append(source2._values[0])
            source2._values.pop(0)

        while len(long) > 0:
            self._values.append(long[0])
            long.pop(0)
    ...
    def find(self, key):
        ...
        if index != -1 and len(self._values) > 0:
    ...
    def split(self):
        ...
        if len(self._values) % 2 == 0:
            middle = int(len(self._values) / 2)
        else:
            middle = int((len(self._values) // 2) + 1)
